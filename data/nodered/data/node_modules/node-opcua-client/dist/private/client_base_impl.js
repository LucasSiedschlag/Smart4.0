   ...
   x  */
    ...
    createDefaultCertificate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!fs.existsSync(this.certificateFile)) {
                yield (0, global_mutex_1.withLock)({ fileToLock: this.certificateFile + ".mutex" }, () => __awaiter(this, void 0, void 0, function* () {
                    if (fs.existsSync(this.certificateFile)) {
    ...
    initializeCM() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.disconnecting)
                return;
            yield this.clientCertificateManager.withLock2(() => __awaiter(this, void 0, void 0, function* () {
                yield (0, verify_1.performCertificateSanityCheck)(this, "client", this.clientCertificateManager, this._getBuiltApplicationUri());
            }));
        });
    }
    ...
    _install_secure_channel_event_handlers(secureChannel) {
        ...
        secureChannel.on("close", (err) => {
            ...
            debugLog(chalk_1.default.yellow.bold(" ClientBaseImpl emitting close"), err === null || err === void 0 ? void 0 : err.message);
            this._destroy_secure_channel();
