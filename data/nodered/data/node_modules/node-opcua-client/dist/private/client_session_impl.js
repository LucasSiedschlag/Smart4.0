...
class ClientSessionImpl extends events_1.EventEmitter {
    ...
    requestReconnection() {
        if (this._client) {
            ...
            (0, node_opcua_assert_1.assert)(this._client.isReconnecting === true, "expecting client to be reconnecting now");
        }
    }
    ...
    recreate_session_and_reperform_transaction(request, callback) {
        ...
        debugLog(chalk_1.default.red("----------------> Repairing Client Session as Server believes it is invalid now "));
        (0, reconnection_1.repair_client_session)(this._client, this, (err) => {
            this.recursive_repair_detector -= 1;
            if (err) {
                debugLog(chalk_1.default.red("----------------> session Repaired has failed with error", err.message));
                return callback(err);
            }
            debugLog(chalk_1.default.red("----------------> session Repaired, now redoing original transaction "));
...
const promoteOpaqueStructureWithCallback = (0, util_1.callbackify)(node_opcua_client_dynamic_extension_object_1.promoteOpaqueStructure);
const promoteOpaqueStructure3WithCallback = (0, util_1.callbackify)(promoteOpaqueStructure3);
