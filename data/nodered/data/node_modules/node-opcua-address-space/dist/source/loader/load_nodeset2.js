...
function makeNodeSetParserEngine(addressSpace, options) {
    ...
    const state_UAObject = {
        init(name, attrs) {
            ...
            this.obj.isAbstract = (0, node_opcua_basic_types_1.coerceBoolean)(attrs.IsAbstract);
            this.obj.nodeId = convertToNodeId(attrs.NodeId) || null;
            this.obj.browseName = convertQualifiedName(attrs.BrowseName);
            this.obj.eventNotifier = (0, node_opcua_basic_types_1.coerceByte)(attrs.EventNotifier) || 0;
    ...
    const state_UADataType = {
        init(name, attrs) {
            ...
            this.obj.isAbstract = (0, node_opcua_basic_types_1.coerceBoolean)(attrs.IsAbstract) || false;
            this.obj.nodeId = convertToNodeId(attrs.NodeId) || null;
            this.obj.browseName = convertQualifiedName(attrs.BrowseName);
    ...
    const state_UAVariable = {
        init(name, attrs) {
            ...
            this.obj.valueRank = attrs.ValueRank === undefined ? -1 : (0, node_opcua_basic_types_1.coerceInt32)(attrs.ValueRank);
    ...
    const state_UAVariableType = {
        init(name, attrs) {
            ...
            this.obj.valueRank = (0, node_opcua_basic_types_1.coerceInt32)(attrs.ValueRank) || -1;
            this.obj.arrayDimensions = this.obj.valueRank <= 0 ? null : stringToUInt32Array(attrs.ArrayDimensions);
            this.obj.minimumSamplingInterval = attrs.MinimumSamplingInterval ? parseInt(attrs.MinimumSamplingInterval, 10) : 0;
            this.obj.historizing = false;
            this.obj.nodeId = convertToNodeId(attrs.NodeId) || null;
