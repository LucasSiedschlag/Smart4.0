            ...
            if (hasProperty(data, lowerName)) {
                ...
                if (doDebug) {
                    if (node.modellingRule === "Mandatory") {
                        ...
                        console.log(chalk_1.default.red("ERROR : AddressSpace#constructEventData(eventType,options) " + "cannot find property ") +
                            self.browseName.toString() +
                            " => " +
                            chalk_1.default.cyan(lowerName));
                    }
                    else {
                        console.log(chalk_1.default.yellow("Warning : AddressSpace#constructEventData(eventType,options)" + " cannot find property ") +
                            self.browseName.toString() +
                            " => " +
                            chalk_1.default.cyan(lowerName));
                    }
