...
function verifyCertificateOrClrSignature(certificateOrCrl, parentCertificate) {
    var block_info = (0, asn1_js_1.readTag)(certificateOrCrl, 0);
    var blocks = (0, asn1_js_1._readStruct)(certificateOrCrl, block_info);
    var bufferToBeSigned = certificateOrCrl.subarray(block_info.position, blocks[1].position - 2);
    var signatureAlgorithm = (0, asn1_js_1._readAlgorithmIdentifier)(certificateOrCrl, blocks[1]);
    var signatureValue = (0, asn1_js_1._readSignatureValueBin)(certificateOrCrl, blocks[2]);
    var p = (0, crypto_explore_certificate_js_1.split_der)(parentCertificate)[0];
    var certPem = (0, crypto_utils_js_1.toPem)(p, "CERTIFICATE");
    var verify = (0, crypto_1.createVerify)(signatureAlgorithm.identifier);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            for (index = 1; index < certificateChain.length; index++) {
                ...
                certParentInfo = (0, crypto_explore_certificate_js_1.exploreCertificate)(certParent);
                ...
                certInfo = (0, crypto_explore_certificate_js_1.exploreCertificate)(cert);
