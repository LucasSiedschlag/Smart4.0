 ...
 * @private
 */
function extractFields(session, nodeId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function _flushPendingInvestigations() {
            return __awaiter(this, void 0, void 0, function* () {
                if (stack.length === 0) {
                    return;
                }
                ...
                yield _flushPendingInvestigations();
            });
        }
        function _investigateTopLevel(parent, eventNodeId) {
            return __awaiter(this, void 0, void 0, function* () {
